    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-purple-200">Geometric Art Analysis & Regeneration</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent pr-12"
          ...
          <div className="mt-6 text-center">
            <p className="text-white/60 text-sm">
              Discover the mathematical beauty of traditional kolam patterns
            </p>
          </div>
        </div>
      </div>
